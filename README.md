...
<span>｜</span>
<a href="./I18N/README.md">English</a>
</p>
...
<!-- Summary Start -->
版本库中共有`506`篇文章，总计`100835`行，`1224061`字，`3331538`字符。
<!-- Summary End -->
...
* [低代码场景的状态管理方案](React/低代码场景的状态管理方案.md)
...
* [BGF处理Git历史Blob文件](Plugin/BGF处理Git历史Blob文件.md)
...
* [初探富文本之序列化与反序列化](RichText/初探富文本之序列化与反序列化.md)
...
* [浏览器选区模型的核心交互策略](RichText/浏览器选区模型的核心交互策略.md)
* [编辑器选区模型的状态结构表达](RichText/编辑器选区模型的状态结构表达.md)
* [浏览器选区与编辑器选区模型同步](RichText/浏览器选区与编辑器选区模型同步.md)
