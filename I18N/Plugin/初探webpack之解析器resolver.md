...
For these three issues, I have implemented related demos using `Webpack`. The relevant code can be found at `https://github.com/WindrunnerMax/webpack-env/tree/master/packages/webpack-resolver`.
